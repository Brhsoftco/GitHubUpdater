...
{
    internal static class VersionVerify
    {
        internal static Version ToValid(this Version v)
        {
            try
            {
        ...
        internal static string ToValidVersionString(this string version)
        {
            try
            {
        ...
        /// <returns></returns>
        internal static string GetValidVersionString(this string input)
        {
            var r = new Regex("[^0-9.]");
