...
{
    internal partial class Update : Form
    {
        ...
        /// <param name="e"></param>
        private void ExecuteDownload(object sender, GHUWaitWindowEventArgs e)
        ...
        private DownloadStatus ExecuteDownload(bool waitWindow = true)
        {
            //wait window
            if (waitWindow)
                return (DownloadStatus)GHUWaitWindow.Show(ExecuteDownload, @"Downloading update");
