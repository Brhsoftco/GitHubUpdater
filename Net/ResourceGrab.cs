...
namespace GitHubUpdater.Net
{
    ...
    /// </summary>
    internal static class ResourceGrab
    {
        /// <summary>
        /// Stores the most recent HTTP response status code
        /// </summary>
        internal static string LastStatusCode { get; set; } = @"";
        ...
        /// <returns></returns>
        internal static string GrabString(Uri uri, string referrer = @"", string method = @"GET")
        ...
        /// <param name="method"></param>
        /// <returns></returns>
        internal static string GrabString(string uri, string referrer = @"", string method = @"GET")
        {
            //download raw bytes
        ...
        /// <param name="method"></param>
        /// <returns></returns>
        internal static byte[] GrabBytes(Uri uri, string referrer = @"", string method = @"GET")
        ...
        /// <param name="method"></param>
        /// <returns></returns>
        internal static byte[] GrabBytes(string uri, string referrer = @"", string method = @"GET")
        {
            //request handler
